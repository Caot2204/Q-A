        ...
        if (cadena != null && !cadena.isEmpty()) {
            if (cadena.length() <= longitudMaxima && cadena.length() > longitudMinima) {
                ...
                if (!primerCaracter.equals(" ")) {
                    ...
                    throw new IllegalArgumentException("El campo no puede empezar con espacio en blanco");
                }
            } else {
                throw new IllegalArgumentException("El tamaño válido del campo es de " 
                                                    + Integer.toString(longitudMinima) 
                                                    + " hasta "
                                                    + Integer.toString(longitudMaxima) 
                                                    + " caracteres");
            }
        } else {
            throw new IllegalArgumentException("No deje el campo vacío");
        }
