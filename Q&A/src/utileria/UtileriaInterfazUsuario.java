...
public class UtileriaInterfazUsuario {
     ...
     *
     * @param clase
     * @param llaveTitulo Llave para archivo de propiedades que contiene el titulo de la ventana en el idioma actual
    ...
    public static void mostrarVentana(Class clase, String llaveTitulo, String nombreFXML, Control elementoInterfaz) {
        ...
        recurso = ResourceBundle.getBundle("lang.lang", locale);
     ...
     *
     * @param llaveTitulo Llave para archivo de propiedades que contiene el Titulo del mensaje en el idioma actual
     * @param llaveEncabezado Llave para archivo de propiedades que contiene el Encabezado de la ventana del mensaje
     * @param llaveMensaje Llave para archivo de propiedades que contiene el Mensaje que se desea mostrar al usuario
     */
    ...
    /**
     * Genera un mensaje de error para el usuario, notificando que la cadena esta dentro 
     * del rango permitido de caracteres
     * 
